...
public class EnglishQuizActivity extends AppCompatActivity {
    private ActivityEnglishQuizBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityEnglishQuizBinding.inflate(getLayoutInflater());
    ...
    private void loadAllQuestions(){
        ...
        String jsonquiz = loadJsonFromAssets("englishquestion.json");
        try {
            JSONObject jsonObject = new JSONObject(jsonquiz);
            JSONArray jsonArray = jsonObject.getJSONArray("englishquestion");
