...
import com.example.quizapp.databinding.ActivityDifficultQuizBinding;
...
public class DifficultQuizActivity extends AppCompatActivity {
    private ActivityDifficultQuizBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDifficultQuizBinding.inflate(getLayoutInflater());
        ...
        binding.aanswer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentQuestions < questionsItems.size()-1) {
                    ...
                    Intent intent = new Intent(DifficultQuizActivity.this, ResultActivity.class);
    ...
    private void loadAllQuestions() {
        ...
        String jsonquiz = loadJsonFromAssets("difficultquestion.json");
        try {
