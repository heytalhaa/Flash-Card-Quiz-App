...
import com.example.quizapp.databinding.ActivityMathQuizBinding;
...
public class MathQuizActivity extends AppCompatActivity {
    ...
    private void loadAllQuestions(){
        ...
        String jsonquiz = loadJsonFromAssets("mathquestion.json");
        try {
            JSONObject jsonObject = new JSONObject(jsonquiz);
            JSONArray jsonArray = jsonObject.getJSONArray("mathquestion");
